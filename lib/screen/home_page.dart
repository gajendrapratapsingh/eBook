import 'package:ebook/helper/String.dart';
import 'package:ebook/models/Category.dart';
import 'package:ebook/screen/search.dart';
import 'package:ebook/databaseHelper/dbhelper.dart';
      ...
      body: SafeArea(
        child: Stack(
          children: [
            ...
            isDrawerOpen ? Positioned.directional(
